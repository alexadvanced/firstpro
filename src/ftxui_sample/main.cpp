...
// configuration step. It creates a namespace called `firstpro`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", firstpro::cmake::project_name, firstpro::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", firstpro::cmake::project_version);
      return EXIT_SUCCESS;
    }
